...
static const char __pyx_k_cpy_pyx[] = "cpy.pyx";
...
static const char __pyx_k_Created_on_Sun_May_20_14_01_12[] = "\n\nCreated on Sun May 20 14:01:12 2018\n\n\n\n@author: john\n\n";
...
static PyObject *__pyx_kp_s_cpy_pyx;
...
static PyObject *__pyx_pf_3cpy_load_grid(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_coords, PyArrayObject *__pyx_v_weights, PyArrayObject *__pyx_v_grid, int __pyx_v_num); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_3cpy_1load_grid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_3cpy_1load_grid = {"load_grid", (PyCFunction)__pyx_pw_3cpy_1load_grid, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_3cpy_1load_grid(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_coords,&__pyx_n_s_weights,&__pyx_n_s_grid,&__pyx_n_s_num,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_weights)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("load_grid", 1, 4, 4, 1); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_grid)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("load_grid", 1, 4, 4, 2); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_num)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("load_grid", 1, 4, 4, 3); __PYX_ERR(0, 19, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "load_grid") < 0)) __PYX_ERR(0, 19, __pyx_L3_error)
      }
    ...
    __pyx_v_num = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_num == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("load_grid", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cpy.load_grid", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_weights), __pyx_ptype_5numpy_ndarray, 1, "weights", 0))) __PYX_ERR(0, 19, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_grid), __pyx_ptype_5numpy_ndarray, 1, "grid", 0))) __PYX_ERR(0, 19, __pyx_L1_error)
  __pyx_r = __pyx_pf_3cpy_load_grid(__pyx_self, __pyx_v_coords, __pyx_v_weights, __pyx_v_grid, __pyx_v_num);
...
static PyObject *__pyx_pf_3cpy_load_grid(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_coords, PyArrayObject *__pyx_v_weights, PyArrayObject *__pyx_v_grid, int __pyx_v_num) {
  ...
  __pyx_pybuffernd_grid.rcbuffer = &__pyx_pybuffer_grid;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_coords.rcbuffer->pybuffer, (PyObject*)__pyx_v_coords, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 19, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_weights.rcbuffer->pybuffer, (PyObject*)__pyx_v_weights, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 19, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_grid.rcbuffer->pybuffer, (PyObject*)__pyx_v_grid, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 19, __pyx_L1_error)
  }
 ...
 */
    ...
    __pyx_t_4 = -1;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_pybuffernd_coords.diminfo[0].shape;
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_4 = 0;
    } else if (unlikely(__pyx_t_5 >= __pyx_pybuffernd_coords.diminfo[0].shape)) __pyx_t_4 = 0;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_pybuffernd_coords.diminfo[1].shape;
      if (unlikely(__pyx_t_6 < 0)) __pyx_t_4 = 1;
    } else if (unlikely(__pyx_t_6 >= __pyx_pybuffernd_coords.diminfo[1].shape)) __pyx_t_4 = 1;
    if (unlikely(__pyx_t_4 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_4);
      __PYX_ERR(0, 30, __pyx_L1_error)
    }
    ...
    } else if (unlikely(__pyx_t_7 >= __pyx_pybuffernd_coords.diminfo[0].shape)) __pyx_t_4 = 0;
    if (__pyx_t_8 < 0) {
      __pyx_t_8 += __pyx_pybuffernd_coords.diminfo[1].shape;
      if (unlikely(__pyx_t_8 < 0)) __pyx_t_4 = 1;
    } else if (unlikely(__pyx_t_8 >= __pyx_pybuffernd_coords.diminfo[1].shape)) __pyx_t_4 = 1;
    if (unlikely(__pyx_t_4 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_4);
      __PYX_ERR(0, 30, __pyx_L1_error)
    }
    ...
    __pyx_t_4 = -1;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_pybuffernd_coords.diminfo[0].shape;
      if (unlikely(__pyx_t_9 < 0)) __pyx_t_4 = 0;
    } else if (unlikely(__pyx_t_9 >= __pyx_pybuffernd_coords.diminfo[0].shape)) __pyx_t_4 = 0;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_pybuffernd_coords.diminfo[1].shape;
      if (unlikely(__pyx_t_10 < 0)) __pyx_t_4 = 1;
    } else if (unlikely(__pyx_t_10 >= __pyx_pybuffernd_coords.diminfo[1].shape)) __pyx_t_4 = 1;
    if (unlikely(__pyx_t_4 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_4);
      __PYX_ERR(0, 30, __pyx_L1_error)
    }
    __pyx_t_11 = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int64_t *, __pyx_pybuffernd_coords.rcbuffer->pybuffer.buf, __pyx_t_5, __pyx_pybuffernd_coords.diminfo[0].strides, __pyx_t_6, __pyx_pybuffernd_coords.diminfo[1].strides));
    __pyx_t_12 = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int64_t *, __pyx_pybuffernd_coords.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_coords.diminfo[0].strides, __pyx_t_8, __pyx_pybuffernd_coords.diminfo[1].strides));
    __pyx_t_13 = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int64_t *, __pyx_pybuffernd_coords.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_coords.diminfo[0].strides, __pyx_t_10, __pyx_pybuffernd_coords.diminfo[1].strides));
    __pyx_t_4 = -1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_pybuffernd_grid.diminfo[0].shape;
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_4 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_pybuffernd_grid.diminfo[0].shape)) __pyx_t_4 = 0;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_pybuffernd_grid.diminfo[1].shape;
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_4 = 1;
    } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_grid.diminfo[1].shape)) __pyx_t_4 = 1;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_pybuffernd_grid.diminfo[2].shape;
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_4 = 2;
    } else if (unlikely(__pyx_t_13 >= __pyx_pybuffernd_grid.diminfo[2].shape)) __pyx_t_4 = 2;
    if (unlikely(__pyx_t_4 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_4);
      __PYX_ERR(0, 30, __pyx_L1_error)
    }
    *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_grid.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_grid.diminfo[0].strides, __pyx_t_12, __pyx_pybuffernd_grid.diminfo[1].strides, __pyx_t_13, __pyx_pybuffernd_grid.diminfo[2].strides) += (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_weights.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_weights.diminfo[0].strides));
  }
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "cpy",
    __pyx_k_Created_on_Sun_May_20_14_01_12, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_cpy_pyx, __pyx_k_cpy_pyx, sizeof(__pyx_k_cpy_pyx), 0, 0, 1, 0},
 ...
 * 
 */
  __pyx_tuple__10 = PyTuple_Pack(5, __pyx_n_s_coords, __pyx_n_s_weights, __pyx_n_s_grid, __pyx_n_s_num, __pyx_n_s_i); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(4, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cpy_pyx, __pyx_n_s_load_grid, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cpy", __pyx_methods, __pyx_k_Created_on_Sun_May_20_14_01_12, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "cpy")) {
      if (unlikely(PyDict_SetItemString(modules, "cpy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3cpy_1load_grid, NULL, __pyx_n_s_cpy); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_load_grid, __pyx_t_1) < 0) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cpy", 0, __pyx_lineno, __pyx_filename);
    }
